# UHAKI LEGAL ASSISTANT SYSTEM TECHNICAL REPORT
## 1. Executive summary
Implemented a legal assistant system where users can input legal queries and receive answers based on information from Kenya's legal corpus.It was implemented using Retrieval Augmented Generation using Qwen Large Language Model with a recall of **85%** , mean reciprocal rank of **70.63** and a Natural Language Inference probability mean of **79.92%**. The system includes retrieval from a vector database and response generation using Qwen LLM.
...
#### 2.1.1 Overview
- The dataset was obtained from the new kenya law website which had the Acts of Parliament and Constitution of Kenya. A total of 20 acts were chosen.
...
#### 2.2.2 Retrieval Stack (Embeddings + Vector Store)
...
#### 2.2.4 Answer Generation / Formatting
